...
mounted: function() {
    ...
    if (id) {
      console.log(id);
      this.axios
        .get("http://172.21.213.242:8080//Knowledge/GetSceneByIdServlet", {
          params: {
            id: id
          }
        })
  ...
  methods: {
    ...
    addLocation(formName) {
      ...
      if (flag) {
        ...
        this.axios({
          method: "post",
          url: "http://172.21.213.242:8080//Knowledge/AddLocationServlet",
          headers: {
    ...
    getAllCharacterInfo() {
      var that = this;
      this.axios
        .get("http://172.21.213.242:8080//Knowledge/GetAllResearcherServlet")
        .then(function(response) {
    ...
    getAllModelInfo() {
      var that = this;
      this.axios
        .get("http://172.21.213.242:8080//Knowledge/GetAllModelServlet")
        .then(function(response) {
    ...
    addScene(formName) {
      ...
      if (flag) {
        ...
        this.axios({
          method: "post",
          url: "http://172.21.213.242:8080//Knowledge/AddSceneServlet",
          headers: {
            "Content-Type": "application/x-www-form-urlencoded;charset=utf-8"
          },
          data: this.qs.stringify(param)
