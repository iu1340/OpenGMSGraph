...
<template>
  <div>
    <knowledge-separator item="位置"></knowledge-separator>
    <div class="tool-panel">
      <el-button type="success" @click="$router.push('/system/createLocation')">创建</el-button>
      ...
      <el-card v-for="(item, index) in cards" :key="index" class="box-card">
        <div slot="header" class="clearfix">
          ...
          <div style="float: right;">
            <el-button class="card-button" type="warning" icon="el-icon-edit" @click="$router.push('/system/editLocation/'+item.id)"></el-button>
...
export default {
  ...
  methods: {
    ...
    getCards: function(page) {
      var that = this;
      this.axios
        .get("http://172.21.213.242:8080//Knowledge/GetLocationByPageServlet", {
          params: {
            page: page
          }
        })
    ...
    deleteCard: function(itemId) {
      var that = this;
      this.axios
        .get("http://172.21.213.242:8080//Knowledge/DeleteLocationServlet", {
          params: {
            id: itemId
          }
        })
